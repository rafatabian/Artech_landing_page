...
const Landing_faq = () => {
  const questionsData = [
    ...
    },
    {
      ...
      answer: 'Most clinics see a 30–45% increase in lead response rates within the first 14 days. Since the automation is instant, the leak in your budget is plugged the moment we go live.',
    },
    {
